#!/usr/bin/env python3
"""
i2i-kamui-flux-kontext-lora - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_flux_kontext_lora.py --args '{"prompt": "..."}'
    python i2i_kamui_flux_kontext_lora.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_flux_kontext_lora.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/flux/kontext"),
    ("--submit-tool", "flux_kontext_lora_submit"),
    ("--status-tool", "flux_kontext_lora_status"),
    ("--result-tool", "flux_kontext_lora_result"),
