#!/usr/bin/env python3
"""
i2i-kamui-fal-sam-3-image - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_fal_sam_3_image.py --args '{"prompt": "..."}'
    python i2i_kamui_fal_sam_3_image.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_fal_sam_3_image.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/sam-3/image"),
    ("--submit-tool", "sam_3_image_submit"),
    ("--status-tool", "sam_3_image_status"),
    ("--result-tool", "sam_3_image_result"),
