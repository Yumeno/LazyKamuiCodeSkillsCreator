#!/usr/bin/env python3
"""
t2i-kamui-flux-2-flex - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_flux_2_flex.py --args '{"prompt": "..."}'
    python t2i_kamui_flux_2_flex.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_flux_2_flex.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/flux-2-flex"),
    ("--submit-tool", "flux_2_flex_submit"),
    ("--status-tool", "flux_2_flex_status"),
    ("--result-tool", "flux_2_flex_result"),
