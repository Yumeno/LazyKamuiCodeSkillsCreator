#!/usr/bin/env python3
"""
i2i-kamui-crystal-upscaler - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_crystal_upscaler.py --args '{"prompt": "..."}'
    python i2i_kamui_crystal_upscaler.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_crystal_upscaler.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/crystal-upscaler"),
    ("--submit-tool", "crystal_upscaler_submit"),
    ("--status-tool", "crystal_upscaler_status"),
    ("--result-tool", "crystal_upscaler_result"),
