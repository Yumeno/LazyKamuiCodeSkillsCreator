#!/usr/bin/env python3
"""
i2i-kamui-lucidflux - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_lucidflux.py --args '{"prompt": "..."}'
    python i2i_kamui_lucidflux.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_lucidflux.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/lucidflux"),
    ("--submit-tool", "lucidflux_i2i_submit"),
    ("--status-tool", "lucidflux_i2i_status"),
    ("--result-tool", "lucidflux_i2i_result"),
