#!/usr/bin/env python3
"""
t2i-kamui-fal-gemini-3-pro-image-preview - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_fal_gemini_3_pro_image_preview.py --args '{"prompt": "..."}'
    python t2i_kamui_fal_gemini_3_pro_image_preview.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_fal_gemini_3_pro_image_preview.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/gemini-3-pro-image-preview"),
    ("--submit-tool", "gemini_3_pro_image_preview_submit"),
    ("--status-tool", "gemini_3_pro_image_preview_status"),
    ("--result-tool", "gemini_3_pro_image_preview_result"),
