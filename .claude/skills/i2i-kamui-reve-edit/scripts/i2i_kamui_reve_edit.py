#!/usr/bin/env python3
"""
i2i-kamui-reve-edit - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_reve_edit.py --args '{"prompt": "..."}'
    python i2i_kamui_reve_edit.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_reve_edit.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/reve/edit"),
    ("--submit-tool", "reve_edit_submit"),
    ("--status-tool", "reve_edit_status"),
    ("--result-tool", "reve_edit_result"),
