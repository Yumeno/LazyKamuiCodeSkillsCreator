#!/usr/bin/env python3
"""
t2i-kamui-fal-z-image-turbo - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_fal_z_image_turbo.py --args '{"prompt": "..."}'
    python t2i_kamui_fal_z_image_turbo.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_fal_z_image_turbo.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/z-image-turbo"),
    ("--submit-tool", "z_image_turbo_submit"),
    ("--status-tool", "z_image_turbo_status"),
    ("--result-tool", "z_image_turbo_result"),
