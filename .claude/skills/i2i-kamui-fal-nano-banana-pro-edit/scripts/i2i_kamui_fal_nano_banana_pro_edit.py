#!/usr/bin/env python3
"""
i2i-kamui-fal-nano-banana-pro-edit - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_fal_nano_banana_pro_edit.py --args '{"prompt": "..."}'
    python i2i_kamui_fal_nano_banana_pro_edit.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_fal_nano_banana_pro_edit.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/nano-banana-pro/edit"),
    ("--submit-tool", "nano_banana_pro_edit_submit"),
    ("--status-tool", "nano_banana_pro_edit_status"),
    ("--result-tool", "nano_banana_pro_edit_result"),
