#!/usr/bin/env python3
"""
i2i-kamui-qwen-image-edit-2511 - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_qwen_image_edit_2511.py --args '{"prompt": "..."}'
    python i2i_kamui_qwen_image_edit_2511.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_qwen_image_edit_2511.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/qwen-image-edit-2511"),
    ("--submit-tool", "qwen_image_edit_2511_submit"),
    ("--status-tool", "qwen_image_edit_2511_status"),
    ("--result-tool", "qwen_image_edit_2511_result"),
