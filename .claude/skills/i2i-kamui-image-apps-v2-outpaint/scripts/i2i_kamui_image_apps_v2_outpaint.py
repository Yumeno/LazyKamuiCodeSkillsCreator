#!/usr/bin/env python3
"""
i2i-kamui-image-apps-v2-outpaint - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_image_apps_v2_outpaint.py --args '{"prompt": "..."}'
    python i2i_kamui_image_apps_v2_outpaint.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_image_apps_v2_outpaint.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/image-apps-v2/outpaint"),
    ("--submit-tool", "image_apps_v2_outpaint_submit"),
    ("--status-tool", "image_apps_v2_outpaint_status"),
    ("--result-tool", "image_apps_v2_outpaint_result"),
