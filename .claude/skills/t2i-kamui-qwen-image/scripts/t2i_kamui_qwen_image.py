#!/usr/bin/env python3
"""
t2i-kamui-qwen-image - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_qwen_image.py --args '{"prompt": "..."}'
    python t2i_kamui_qwen_image.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_qwen_image.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/qwen-image"),
    ("--submit-tool", "qwen_image_t2i_submit"),
    ("--status-tool", "qwen_image_t2i_status"),
    ("--result-tool", "qwen_image_t2i_result"),
