#!/usr/bin/env python3
"""
i2i-kamui-easel-ai-fashion-size-estimator - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_easel_ai_fashion_size_estimator.py --args '{"prompt": "..."}'
    python i2i_kamui_easel_ai_fashion_size_estimator.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_easel_ai_fashion_size_estimator.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/easel-ai-fashion-size-estimator"),
    ("--submit-tool", "easel_ai_fashion_size_estimator_i2i_submit"),
    ("--status-tool", "easel_ai_fashion_size_estimator_i2i_status"),
    ("--result-tool", "easel_ai_fashion_size_estimator_i2i_result"),
