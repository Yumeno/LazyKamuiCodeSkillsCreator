#!/usr/bin/env python3
"""
i2i-kamui-seedream-v4-5-edit - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_seedream_v4_5_edit.py --args '{"prompt": "..."}'
    python i2i_kamui_seedream_v4_5_edit.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_seedream_v4_5_edit.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/bytedance/seedream/v4.5"),
    ("--submit-tool", "bytedance_seedream_v4_5_edit_submit"),
    ("--status-tool", "bytedance_seedream_v4_5_edit_status"),
    ("--result-tool", "bytedance_seedream_v4_5_edit_result"),
