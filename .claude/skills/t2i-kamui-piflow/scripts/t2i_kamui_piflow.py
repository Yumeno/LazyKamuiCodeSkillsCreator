#!/usr/bin/env python3
"""
t2i-kamui-piflow - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_piflow.py --args '{"prompt": "..."}'
    python t2i_kamui_piflow.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_piflow.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/piflow"),
    ("--submit-tool", "piflow_submit"),
    ("--status-tool", "piflow_status"),
    ("--result-tool", "piflow_result"),
