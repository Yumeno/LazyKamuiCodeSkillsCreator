#!/usr/bin/env python3
"""
i2i-kamui-fal-z-image-turbo-image-to-image - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_fal_z_image_turbo_image_to_image.py --args '{"prompt": "..."}'
    python i2i_kamui_fal_z_image_turbo_image_to_image.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_fal_z_image_turbo_image_to_image.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/z-image-turbo/image-to-image"),
    ("--submit-tool", "z_image_turbo_image_to_image_submit"),
    ("--status-tool", "z_image_turbo_image_to_image_status"),
    ("--result-tool", "z_image_turbo_image_to_image_result"),
