#!/usr/bin/env python3
"""
t2i-kamui-bria-fibo-generate - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_bria_fibo_generate.py --args '{"prompt": "..."}'
    python t2i_kamui_bria_fibo_generate.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_bria_fibo_generate.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/bria/fibo/generate"),
    ("--submit-tool", "bria_fibo_generate_t2i_submit"),
    ("--status-tool", "status"),
    ("--result-tool", "result"),
