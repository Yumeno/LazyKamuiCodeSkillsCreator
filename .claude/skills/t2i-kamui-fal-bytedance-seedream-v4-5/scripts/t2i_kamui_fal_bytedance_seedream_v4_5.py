#!/usr/bin/env python3
"""
t2i-kamui-fal-bytedance-seedream-v4-5 - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_fal_bytedance_seedream_v4_5.py --args '{"prompt": "..."}'
    python t2i_kamui_fal_bytedance_seedream_v4_5.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_fal_bytedance_seedream_v4_5.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/bytedance/seedream/v4.5"),
    ("--submit-tool", "bytedance_seedream_v4_5_text_to_image_submit"),
    ("--status-tool", "bytedance_seedream_v4_5_text_to_image_status"),
    ("--result-tool", "bytedance_seedream_v4_5_text_to_image_result"),
