#!/usr/bin/env python3
"""
t2i-kamui-ideogram-character-base - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_ideogram_character_base.py --args '{"prompt": "..."}'
    python t2i_kamui_ideogram_character_base.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_ideogram_character_base.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/ideogram/character-base"),
    ("--submit-tool", "ideogram_character_base_submit"),
    ("--status-tool", "ideogram_character_base_status"),
    ("--result-tool", "ideogram_character_base_result"),
