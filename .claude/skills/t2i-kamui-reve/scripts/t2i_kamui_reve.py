#!/usr/bin/env python3
"""
t2i-kamui-reve - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_reve.py --args '{"prompt": "..."}'
    python t2i_kamui_reve.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_reve.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/reve/text-to-image"),
    ("--submit-tool", "reve_text_to_image_submit"),
    ("--status-tool", "reve_text_to_image_status"),
    ("--result-tool", "reve_text_to_image_result"),
