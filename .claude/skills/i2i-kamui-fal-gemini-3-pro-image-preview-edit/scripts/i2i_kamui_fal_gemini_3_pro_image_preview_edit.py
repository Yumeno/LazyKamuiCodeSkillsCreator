#!/usr/bin/env python3
"""
i2i-kamui-fal-gemini-3-pro-image-preview-edit - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_fal_gemini_3_pro_image_preview_edit.py --args '{"prompt": "..."}'
    python i2i_kamui_fal_gemini_3_pro_image_preview_edit.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_fal_gemini_3_pro_image_preview_edit.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/gemini-3-pro-image-preview/edit"),
    ("--submit-tool", "gemini_3_pro_image_preview_edit_submit"),
    ("--status-tool", "gemini_3_pro_image_preview_edit_status"),
    ("--result-tool", "gemini_3_pro_image_preview_edit_result"),
