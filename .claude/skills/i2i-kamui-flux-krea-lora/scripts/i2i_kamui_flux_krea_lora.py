#!/usr/bin/env python3
"""
i2i-kamui-flux-krea-lora - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_flux_krea_lora.py --args '{"prompt": "..."}'
    python i2i_kamui_flux_krea_lora.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_flux_krea_lora.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/flux-krea-lora/image-to-image"),
    ("--submit-tool", "flux_krea_lora_i2i_submit"),
    ("--status-tool", "flux_krea_lora_i2i_status"),
    ("--result-tool", "flux_krea_lora_i2i_result"),
