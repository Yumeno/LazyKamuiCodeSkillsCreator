#!/usr/bin/env python3
"""
t2i-kamui-ovis-image - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_ovis_image.py --args '{"prompt": "..."}'
    python t2i_kamui_ovis_image.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_ovis_image.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/ovis-image"),
    ("--submit-tool", "ovis_image_submit"),
    ("--status-tool", "ovis_image_status"),
    ("--result-tool", "ovis_image_result"),
