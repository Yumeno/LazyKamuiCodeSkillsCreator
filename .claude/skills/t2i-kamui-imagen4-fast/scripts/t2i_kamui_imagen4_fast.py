#!/usr/bin/env python3
"""
t2i-kamui-imagen4-fast - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_imagen4_fast.py --args '{"prompt": "..."}'
    python t2i_kamui_imagen4_fast.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_imagen4_fast.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/imagen4/fast"),
    ("--submit-tool", "imagen4_fast_submit"),
    ("--status-tool", "imagen4_fast_status"),
    ("--result-tool", "imagen4_fast_result"),
