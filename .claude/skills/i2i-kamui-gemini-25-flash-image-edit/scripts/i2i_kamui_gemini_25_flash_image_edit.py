#!/usr/bin/env python3
"""
i2i-kamui-gemini-25-flash-image-edit - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_gemini_25_flash_image_edit.py --args '{"prompt": "..."}'
    python i2i_kamui_gemini_25_flash_image_edit.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_gemini_25_flash_image_edit.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/gemini-25-flash-image/edit"),
    ("--submit-tool", "gemini_25_flash_image_edit_submit"),
    ("--status-tool", "gemini_25_flash_image_edit_status"),
    ("--result-tool", "gemini_25_flash_image_edit_result"),
