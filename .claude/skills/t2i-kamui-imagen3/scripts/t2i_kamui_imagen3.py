#!/usr/bin/env python3
"""
t2i-kamui-imagen3 - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_imagen3.py --args '{"prompt": "..."}'
    python t2i_kamui_imagen3.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_imagen3.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/google/imagen"),
    ("--submit-tool", "imagen_t2i"),
    ("--status-tool", "status"),
    ("--result-tool", "imagen_t2i"),
