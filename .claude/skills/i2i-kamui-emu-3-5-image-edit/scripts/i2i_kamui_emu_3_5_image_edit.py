#!/usr/bin/env python3
"""
i2i-kamui-emu-3-5-image-edit - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_emu_3_5_image_edit.py --args '{"prompt": "..."}'
    python i2i_kamui_emu_3_5_image_edit.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_emu_3_5_image_edit.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/emu-3.5-image/edit"),
    ("--submit-tool", "emu_3_5_image_edit_image_submit"),
    ("--status-tool", "emu_3_5_image_edit_image_status"),
    ("--result-tool", "emu_3_5_image_edit_image_result"),
