#!/usr/bin/env python3
"""
i2i-kamui-kling-image-o1 - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_kling_image_o1.py --args '{"prompt": "..."}'
    python i2i_kamui_kling_image_o1.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_kling_image_o1.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/kling-image/o1"),
    ("--submit-tool", "kling_image_o1_submit"),
    ("--status-tool", "kling_image_o1_status"),
    ("--result-tool", "kling_image_o1_result"),
