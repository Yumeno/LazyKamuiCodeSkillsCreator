#!/usr/bin/env python3
"""
i2i-kamui-flux-2-max-edit - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_flux_2_max_edit.py --args '{"prompt": "..."}'
    python i2i_kamui_flux_2_max_edit.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_flux_2_max_edit.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/flux-2-max/edit"),
    ("--submit-tool", "flux_2_max_edit_submit"),
    ("--status-tool", "flux_2_max_edit_status"),
    ("--result-tool", "flux_2_max_edit_result"),
