#!/usr/bin/env python3
"""
t2i-kamui-nano-banana - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_nano_banana.py --args '{"prompt": "..."}'
    python t2i_kamui_nano_banana.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_nano_banana.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/nano-banana"),
    ("--submit-tool", "nano_banana_t2i_submit"),
    ("--status-tool", "nano_banana_t2i_status"),
    ("--result-tool", "nano_banana_t2i_result"),
