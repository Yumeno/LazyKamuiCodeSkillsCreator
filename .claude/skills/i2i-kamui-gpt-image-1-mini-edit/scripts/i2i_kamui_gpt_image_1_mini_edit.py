#!/usr/bin/env python3
"""
i2i-kamui-gpt-image-1-mini-edit - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_gpt_image_1_mini_edit.py --args '{"prompt": "..."}'
    python i2i_kamui_gpt_image_1_mini_edit.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_gpt_image_1_mini_edit.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/gpt-image-1-mini/edit"),
    ("--submit-tool", "gpt_image_1_mini_edit_submit"),
    ("--status-tool", "gpt_image_1_mini_edit_status"),
    ("--result-tool", "gpt_image_1_mini_edit_result"),
