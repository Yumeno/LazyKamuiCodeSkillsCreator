#!/usr/bin/env python3
"""
t2i-kamui-gpt-image-1-mini - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_gpt_image_1_mini.py --args '{"prompt": "..."}'
    python t2i_kamui_gpt_image_1_mini.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_gpt_image_1_mini.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/gpt-image-1-mini"),
    ("--submit-tool", "gpt_image_1_mini_t2i_submit"),
    ("--status-tool", "gpt_image_1_mini_t2i_status"),
    ("--result-tool", "gpt_image_1_mini_t2i_result"),
