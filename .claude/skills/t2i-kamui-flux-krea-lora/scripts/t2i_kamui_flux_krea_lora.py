#!/usr/bin/env python3
"""
t2i-kamui-flux-krea-lora - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_flux_krea_lora.py --args '{"prompt": "..."}'
    python t2i_kamui_flux_krea_lora.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_flux_krea_lora.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/flux-krea-lora"),
    ("--submit-tool", "flux_krea_lora_t2i_submit"),
    ("--status-tool", "flux_krea_lora_t2i_status"),
    ("--result-tool", "flux_krea_lora_t2i_result"),
