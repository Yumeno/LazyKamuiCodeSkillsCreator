#!/usr/bin/env python3
"""
i2i-kamui-fal-longcat-image-edit - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_fal_longcat_image_edit.py --args '{"prompt": "..."}'
    python i2i_kamui_fal_longcat_image_edit.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_fal_longcat_image_edit.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/longcat-image/edit"),
    ("--submit-tool", "longcat_image_edit_submit"),
    ("--status-tool", "longcat_image_edit_status"),
    ("--result-tool", "longcat_image_edit_result"),
