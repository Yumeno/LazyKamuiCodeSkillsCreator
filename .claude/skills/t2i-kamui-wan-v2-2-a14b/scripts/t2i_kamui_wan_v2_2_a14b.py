#!/usr/bin/env python3
"""
t2i-kamui-wan-v2-2-a14b - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_wan_v2_2_a14b.py --args '{"prompt": "..."}'
    python t2i_kamui_wan_v2_2_a14b.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_wan_v2_2_a14b.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/wan/v2.2-a14b/text-to-image"),
    ("--submit-tool", "wan_v2_2_a14b_text_to_image_submit"),
    ("--status-tool", "wan_v2_2_a14b_text_to_image_status"),
    ("--result-tool", "wan_v2_2_a14b_text_to_image_result"),
