#!/usr/bin/env python3
"""
i2i-kamui-fal-z-image-turbo-controlnet - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_fal_z_image_turbo_controlnet.py --args '{"prompt": "..."}'
    python i2i_kamui_fal_z_image_turbo_controlnet.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_fal_z_image_turbo_controlnet.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/z-image-turbo/controlnet"),
    ("--submit-tool", "z_image_turbo_controlnet_submit"),
    ("--status-tool", "z_image_turbo_controlnet_status"),
    ("--result-tool", "z_image_turbo_controlnet_result"),
