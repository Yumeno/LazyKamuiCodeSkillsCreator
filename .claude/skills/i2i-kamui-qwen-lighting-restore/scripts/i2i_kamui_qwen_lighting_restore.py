#!/usr/bin/env python3
"""
i2i-kamui-qwen-lighting-restore - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_qwen_lighting_restore.py --args '{"prompt": "..."}'
    python i2i_kamui_qwen_lighting_restore.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_qwen_lighting_restore.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/qwen-image-edit-plus-lora-gallery/lighting-restoration"),
    ("--submit-tool", "qwen_image_edit_plus_lora_gallery_lighting_restoration_submit"),
    ("--status-tool", "qwen_image_edit_plus_lora_gallery_lighting_restoration_status"),
    ("--result-tool", "qwen_image_edit_plus_lora_gallery_lighting_restoration_result"),
