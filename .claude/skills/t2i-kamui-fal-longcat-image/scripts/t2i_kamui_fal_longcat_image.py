#!/usr/bin/env python3
"""
t2i-kamui-fal-longcat-image - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_fal_longcat_image.py --args '{"prompt": "..."}'
    python t2i_kamui_fal_longcat_image.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_fal_longcat_image.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/longcat-image"),
    ("--submit-tool", "longcat_image_submit"),
    ("--status-tool", "longcat_image_status"),
    ("--result-tool", "longcat_image_result"),
