#!/usr/bin/env python3
"""
i2i-kamui-reve-remix - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_reve_remix.py --args '{"prompt": "..."}'
    python i2i_kamui_reve_remix.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_reve_remix.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/reve/remix"),
    ("--submit-tool", "reve_remix_submit"),
    ("--status-tool", "reve_remix_status"),
    ("--result-tool", "reve_remix_result"),
