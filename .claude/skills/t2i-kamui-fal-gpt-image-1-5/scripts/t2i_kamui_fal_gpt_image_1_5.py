#!/usr/bin/env python3
"""
t2i-kamui-fal-gpt-image-1-5 - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_fal_gpt_image_1_5.py --args '{"prompt": "..."}'
    python t2i_kamui_fal_gpt_image_1_5.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_fal_gpt_image_1_5.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/gpt-image-1.5"),
    ("--submit-tool", "gpt_image_1_5_t2i_submit"),
    ("--status-tool", "gpt_image_1_5_t2i_status"),
    ("--result-tool", "gpt_image_1_5_t2i_result"),
