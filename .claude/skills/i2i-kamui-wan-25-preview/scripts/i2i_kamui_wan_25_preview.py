#!/usr/bin/env python3
"""
i2i-kamui-wan-25-preview - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_wan_25_preview.py --args '{"prompt": "..."}'
    python i2i_kamui_wan_25_preview.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_wan_25_preview.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/wan/25-preview"),
    ("--submit-tool", "wan_25_preview_image_to_image_submit"),
    ("--status-tool", "wan_25_preview_image_to_image_status"),
    ("--result-tool", "wan_25_preview_image_to_image_result"),
