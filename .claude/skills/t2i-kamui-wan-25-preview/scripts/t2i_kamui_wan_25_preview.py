#!/usr/bin/env python3
"""
t2i-kamui-wan-25-preview - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_wan_25_preview.py --args '{"prompt": "..."}'
    python t2i_kamui_wan_25_preview.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_wan_25_preview.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/wan/25-preview"),
    ("--submit-tool", "wan_25_preview_text_to_image_submit"),
    ("--status-tool", "wan_25_preview_text_to_image_status"),
    ("--result-tool", "wan_25_preview_text_to_image_result"),
