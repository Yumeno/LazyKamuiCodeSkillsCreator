#!/usr/bin/env python3
"""
i2i-kamui-fal-flux-2-lora-gallery-apartment-staging - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_fal_flux_2_lora_gallery_apartment_staging.py --args '{"prompt": "..."}'
    python i2i_kamui_fal_flux_2_lora_gallery_apartment_staging.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_fal_flux_2_lora_gallery_apartment_staging.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/flux-2-lora-gallery/apartment-staging"),
    ("--submit-tool", "flux_2_lora_gallery_apartment_staging_submit"),
    ("--status-tool", "flux_2_lora_gallery_apartment_staging_status"),
    ("--result-tool", "flux_2_lora_gallery_apartment_staging_result"),
