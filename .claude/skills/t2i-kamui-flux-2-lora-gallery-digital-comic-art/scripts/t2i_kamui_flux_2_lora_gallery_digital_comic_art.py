#!/usr/bin/env python3
"""
t2i-kamui-flux-2-lora-gallery-digital-comic-art - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_flux_2_lora_gallery_digital_comic_art.py --args '{"prompt": "..."}'
    python t2i_kamui_flux_2_lora_gallery_digital_comic_art.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_flux_2_lora_gallery_digital_comic_art.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/flux-2-lora-gallery/digital-comic-art"),
    ("--submit-tool", "flux_2_lora_gallery_digital_comic_art_submit"),
    ("--status-tool", "flux_2_lora_gallery_digital_comic_art_status"),
    ("--result-tool", "flux_2_lora_gallery_digital_comic_art_result"),
