#!/usr/bin/env python3
"""
i2i-kamui-dreamomni2-edit - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_dreamomni2_edit.py --args '{"prompt": "..."}'
    python i2i_kamui_dreamomni2_edit.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_dreamomni2_edit.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/dreamomni2/edit"),
    ("--submit-tool", "dreamomni2_edit_i2i_submit"),
    ("--status-tool", "dreamomni2_edit_i2i_status"),
    ("--result-tool", "dreamomni2_edit_i2i_result"),
