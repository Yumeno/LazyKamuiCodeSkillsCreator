#!/usr/bin/env python3
"""
t2i-kamui-seedream-v4 - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_seedream_v4.py --args '{"prompt": "..."}'
    python t2i_kamui_seedream_v4.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_seedream_v4.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/bytedance/seedream/v4"),
    ("--submit-tool", "bytedance_seedream_v4_text_to_image_submit"),
    ("--status-tool", "bytedance_seedream_v4_text_to_image_status"),
    ("--result-tool", "bytedance_seedream_v4_text_to_image_result"),
