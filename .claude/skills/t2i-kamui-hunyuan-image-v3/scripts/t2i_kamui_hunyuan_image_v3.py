#!/usr/bin/env python3
"""
t2i-kamui-hunyuan-image-v3 - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_hunyuan_image_v3.py --args '{"prompt": "..."}'
    python t2i_kamui_hunyuan_image_v3.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_hunyuan_image_v3.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/hunyuan-image/v3"),
    ("--submit-tool", "hunyuan_image_v3_text_to_image_submit"),
    ("--status-tool", "hunyuan_image_v3_text_to_image_status"),
    ("--result-tool", "hunyuan_image_v3_text_to_image_result"),
