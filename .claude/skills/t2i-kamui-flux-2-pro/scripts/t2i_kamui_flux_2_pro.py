#!/usr/bin/env python3
"""
t2i-kamui-flux-2-pro - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_flux_2_pro.py --args '{"prompt": "..."}'
    python t2i_kamui_flux_2_pro.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_flux_2_pro.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/flux-2-pro"),
    ("--submit-tool", "flux_2_pro_submit"),
    ("--status-tool", "flux_2_pro_status"),
    ("--result-tool", "flux_2_pro_result"),
