#!/usr/bin/env python3
"""
t2i-kamui-dreamina-v31 - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_dreamina_v31.py --args '{"prompt": "..."}'
    python t2i_kamui_dreamina_v31.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_dreamina_v31.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/bytedance/dreamina/v3.1/text-to-image"),
    ("--submit-tool", "bytedance_dreamina_v31_t2i_submit"),
    ("--status-tool", "bytedance_dreamina_v31_t2i_status"),
    ("--result-tool", "bytedance_dreamina_v31_t2i_result"),
