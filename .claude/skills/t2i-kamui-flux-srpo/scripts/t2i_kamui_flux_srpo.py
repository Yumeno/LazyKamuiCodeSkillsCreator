#!/usr/bin/env python3
"""
t2i-kamui-flux-srpo - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_flux_srpo.py --args '{"prompt": "..."}'
    python t2i_kamui_flux_srpo.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_flux_srpo.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/flux/srpo"),
    ("--submit-tool", "flux_srpo_submit"),
    ("--status-tool", "flux_srpo_status"),
    ("--result-tool", "flux_srpo_result"),
