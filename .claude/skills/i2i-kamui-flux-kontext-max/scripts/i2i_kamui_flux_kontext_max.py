#!/usr/bin/env python3
"""
i2i-kamui-flux-kontext-max - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_flux_kontext_max.py --args '{"prompt": "..."}'
    python i2i_kamui_flux_kontext_max.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_flux_kontext_max.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/flux/kontext/max"),
    ("--submit-tool", "flux_kontext_max_submit"),
    ("--status-tool", "flux_kontext_max_status"),
    ("--result-tool", "flux_kontext_max_result"),
