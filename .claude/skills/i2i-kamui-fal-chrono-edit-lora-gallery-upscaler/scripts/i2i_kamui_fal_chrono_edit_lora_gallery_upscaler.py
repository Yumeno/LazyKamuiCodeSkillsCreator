#!/usr/bin/env python3
"""
i2i-kamui-fal-chrono-edit-lora-gallery-upscaler - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_fal_chrono_edit_lora_gallery_upscaler.py --args '{"prompt": "..."}'
    python i2i_kamui_fal_chrono_edit_lora_gallery_upscaler.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_fal_chrono_edit_lora_gallery_upscaler.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/chrono-edit-lora-gallery/upscaler"),
    ("--submit-tool", "chrono_edit_lora_gallery_upscaler_submit"),
    ("--status-tool", "chrono_edit_lora_gallery_upscaler_status"),
    ("--result-tool", "chrono_edit_lora_gallery_upscaler_result"),
