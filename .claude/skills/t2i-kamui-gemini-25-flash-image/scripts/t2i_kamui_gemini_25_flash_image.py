#!/usr/bin/env python3
"""
t2i-kamui-gemini-25-flash-image - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_gemini_25_flash_image.py --args '{"prompt": "..."}'
    python t2i_kamui_gemini_25_flash_image.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_gemini_25_flash_image.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/gemini-25-flash-image"),
    ("--submit-tool", "gemini_25_flash_image_t2i_submit"),
    ("--status-tool", "gemini_25_flash_image_t2i_status"),
    ("--result-tool", "gemini_25_flash_image_t2i_result"),
