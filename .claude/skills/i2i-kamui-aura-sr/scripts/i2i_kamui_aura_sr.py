#!/usr/bin/env python3
"""
i2i-kamui-aura-sr - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_aura_sr.py --args '{"prompt": "..."}'
    python i2i_kamui_aura_sr.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_aura_sr.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/aura-sr"),
    ("--submit-tool", "aura_sr_i2i_submit"),
    ("--status-tool", "aura_sr_i2i_status"),
    ("--result-tool", "aura_sr_i2i_result"),
