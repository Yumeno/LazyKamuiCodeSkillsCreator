#!/usr/bin/env python3
"""
i2i-kamui-image2pixel - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_image2pixel.py --args '{"prompt": "..."}'
    python i2i_kamui_image2pixel.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_image2pixel.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/image2pixel"),
    ("--submit-tool", "image2pixel_i2i_submit"),
    ("--status-tool", "image2pixel_i2i_status"),
    ("--result-tool", "image2pixel_i2i_result"),
