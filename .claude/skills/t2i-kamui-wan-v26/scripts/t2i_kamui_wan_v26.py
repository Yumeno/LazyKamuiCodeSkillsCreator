#!/usr/bin/env python3
"""
t2i-kamui-wan-v26 - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_wan_v26.py --args '{"prompt": "..."}'
    python t2i_kamui_wan_v26.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_wan_v26.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/wan/v2.6"),
    ("--submit-tool", "wan_v2_6_text_to_image_submit"),
    ("--status-tool", "wan_v2_6_text_to_image_status"),
    ("--result-tool", "wan_v2_6_text_to_image_result"),
