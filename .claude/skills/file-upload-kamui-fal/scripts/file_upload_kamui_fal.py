#!/usr/bin/env python3
"""
file-upload-kamui-fal - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python file_upload_kamui_fal.py --args '{"prompt": "..."}'
    python file_upload_kamui_fal.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python file_upload_kamui_fal.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/uploader/fal"),
    ("--submit-tool", "submit"),
    ("--status-tool", "status"),
    ("--result-tool", "result"),
