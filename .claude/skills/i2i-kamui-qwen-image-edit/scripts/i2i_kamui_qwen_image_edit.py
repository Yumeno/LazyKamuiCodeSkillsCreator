#!/usr/bin/env python3
"""
i2i-kamui-qwen-image-edit - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_qwen_image_edit.py --args '{"prompt": "..."}'
    python i2i_kamui_qwen_image_edit.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_qwen_image_edit.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/qwen/image-edit"),
    ("--submit-tool", "qwen_image_edit_submit"),
    ("--status-tool", "qwen_image_edit_status"),
    ("--result-tool", "qwen_image_edit_result"),
