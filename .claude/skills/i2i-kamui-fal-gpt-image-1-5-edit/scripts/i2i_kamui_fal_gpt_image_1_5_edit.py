#!/usr/bin/env python3
"""
i2i-kamui-fal-gpt-image-1-5-edit - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_fal_gpt_image_1_5_edit.py --args '{"prompt": "..."}'
    python i2i_kamui_fal_gpt_image_1_5_edit.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_fal_gpt_image_1_5_edit.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/gpt-image-1.5/edit"),
    ("--submit-tool", "gpt_image_1_5_edit_submit"),
    ("--status-tool", "gpt_image_1_5_edit_status"),
    ("--result-tool", "gpt_image_1_5_edit_result"),
