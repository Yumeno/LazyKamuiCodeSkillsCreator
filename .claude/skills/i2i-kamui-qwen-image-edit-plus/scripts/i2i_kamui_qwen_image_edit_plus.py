#!/usr/bin/env python3
"""
i2i-kamui-qwen-image-edit-plus - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_qwen_image_edit_plus.py --args '{"prompt": "..."}'
    python i2i_kamui_qwen_image_edit_plus.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_qwen_image_edit_plus.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/qwen-image-edit-plus"),
    ("--submit-tool", "qwen_image_edit_plus_submit"),
    ("--status-tool", "qwen_image_edit_plus_status"),
    ("--result-tool", "qwen_image_edit_plus_result"),
