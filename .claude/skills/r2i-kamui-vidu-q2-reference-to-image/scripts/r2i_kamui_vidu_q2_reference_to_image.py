#!/usr/bin/env python3
"""
r2i-kamui-vidu-q2-reference-to-image - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python r2i_kamui_vidu_q2_reference_to_image.py --args '{"prompt": "..."}'
    python r2i_kamui_vidu_q2_reference_to_image.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python r2i_kamui_vidu_q2_reference_to_image.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/r2i/fal/vidu/q2/reference-to-image"),
    ("--submit-tool", "vidu_q2_reference_to_image_submit"),
    ("--status-tool", "vidu_q2_reference_to_image_status"),
    ("--result-tool", "vidu_q2_reference_to_image_result"),
