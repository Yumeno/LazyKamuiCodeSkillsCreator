#!/usr/bin/env python3
"""
i2i-kamui-fal-chrono-edit-lora-gallery-paintbrush - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python i2i_kamui_fal_chrono_edit_lora_gallery_paintbrush.py --args '{"prompt": "..."}'
    python i2i_kamui_fal_chrono_edit_lora_gallery_paintbrush.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python i2i_kamui_fal_chrono_edit_lora_gallery_paintbrush.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/i2i/fal/chrono-edit-lora-gallery/paintbrush"),
    ("--submit-tool", "chrono_edit_lora_gallery_paintbrush_submit"),
    ("--status-tool", "chrono_edit_lora_gallery_paintbrush_status"),
    ("--result-tool", "chrono_edit_lora_gallery_paintbrush_result"),
