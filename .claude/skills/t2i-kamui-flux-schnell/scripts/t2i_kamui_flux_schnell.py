#!/usr/bin/env python3
"""
t2i-kamui-flux-schnell - Wrapper with preset defaults for mcp_async_call.py
...
Usage:
    python t2i_kamui_flux_schnell.py --args '{"prompt": "..."}'
    python t2i_kamui_flux_schnell.py --args '{"prompt": "..."}' --auto-filename --save-logs
    python t2i_kamui_flux_schnell.py --help  # Show all available options
"""
...
DEFAULTS = [
    ("--endpoint", "https://kamui-code.ai/t2i/fal/flux/schnell"),
    ("--submit-tool", "flux_schnell_submit"),
    ("--status-tool", "flux_schnell_status"),
    ("--result-tool", "flux_schnell_result"),
